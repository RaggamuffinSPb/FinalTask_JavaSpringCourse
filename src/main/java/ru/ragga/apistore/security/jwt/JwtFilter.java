package ru.ragga.apistore.security.jwt;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            if (jwtTokenUtil.validateToken(token)) {
                ...
                log.warn("Токен невалидный или просроченный");
            }
        } else {
            log.warn("Отсутствует/неверный заголовок Authorization. Формат: 'Bearer <token>'");
        }
